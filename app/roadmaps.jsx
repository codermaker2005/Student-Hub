...
export default function Roadmaps() {
  ...
  const sections = [
    ...
    },
    {
      ...
      resources: [
        ...
        { name: "W3Schools: React Tutorial", link: "https://www.w3schools.com/react/default.asp" }
      ],
    },
    {
      title: "Tailwind CSS",
    ...
    },
    {
      ...
      resources: [
        { name: "ESBuild Quickstart - Find Errors Automatically", link: "https://www.youtube.com/watch?v=qhuFviJn-es" },
      ],
    },
    {
      title: "Vite",
  ...
  return (
    <>
      <Navbar />
      <div className="relative min-h-screen bg-gray-900 text-white p-6 pt-24">
        {/* Adjust padding-top to account for the fixed navbar */}
        <h1 className="text-2xl sm:text-3xl font-semibold mb-6 text-center text-gray-100">
          Frontend Development Roadmap
        </h1>
        <p className="text-sm sm:text-base text-center text-gray-400 mb-8">
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4">
          {sections.map((section) => (
            ...
            >
              <h2 className="text-lg sm:text-xl font-semibold mb-3 text-gray-100">
                {section.title}
              </h2>
              <p className="text-sm sm:text-base mb-3 text-gray-400">
                {section.description}
              </p>
              <div>
        ...
        <div className="text-center mt-8">
          <p className="text-2xl sm:text-3xl font-semibold mb-6 text-gray-100">
