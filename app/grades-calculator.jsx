    ...
    <>
      ...
      <div className="min-h-screen bg-gray-900 text-white p-6 flex flex-col justify-center items-center pt-20">
        ...
        <p className="text-center text-gray-400 mb-6 max-w-lg">
          This Grade Calculator helps you estimate your final grade based on the grades you've received in various assessments. You can adjust the percentage weights for each component.
        </p>
        <div className="w-full max-w-3xl bg-gray-800 p-6 rounded-lg border border-gray-700 shadow-lg">
            ...
            <div key={item} className="mb-4">
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="w-16 p-1 text-center rounded-md bg-gray-700 border border-gray-600 text-gray-200 placeholder-gray-400 ml-2"
                  max="100"
                  placeholder="%"
                />
              </div>
